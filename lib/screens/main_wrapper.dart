...
import 'package:pitdeck/services/wrapper_prefs_service.dart';
    ...
    return Consumer2<UserProvider, AuthProvider>(
      builder: (context, userProvider, authProvider, child) {
        ...
        return FutureBuilder<bool>(
          future: WrapperPrefsService.getNeedUsernameSetup(),
          builder: (context, snapshot) {
            if (snapshot.hasData &&
                snapshot.data! &&
                userProvider.needUsernameSetup) {
              WrapperPrefsService.setNeedUsernameSetup(false);
