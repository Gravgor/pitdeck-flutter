...
class _ListForSaleModalState extends State<ListForSaleModal> {
  ...
  Future<void> _listForSale() async {
    ...
    try {
      ...
      SnackBarUtils.showSuccess(context, title: 'Success', message: 'Card listed for sale');
          
    } catch (e) {
      SnackBarUtils.showError(context, title: 'Error', message: 'Error listing card for sale: $e');
    } finally {
